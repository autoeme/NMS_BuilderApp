...
# Rebuild 12 Advanced Technology farm plants (fresh convert from game archive).
# Old OBJs were pre-index-fix (06-07) and superimposed ALL growth stages
# (STEP0+STEP1+STEP2) -> "hairy" overlap. Rebuilt 1:1 from GEO2 interactiveflora
# selecting ONLY the mature stage (STEP2) LOD0 nodes. Same options as reimport_stage2.
...
NAMES = ["farmbarren", "farmdeadcreature", "farmgravitino", "farmlush", "farmnip",
         "farmalbumen", "farmpoop", "farmradioactive", "farmvenomsac", "farmscorched",
         "farmsnow", "farmtoxic"]
...
unreal.log("NMS FIX FARMPLANTS: GOTOVO import=%d miss=%s" % (imp, miss))
try:
