...
# Fix broken Legacy Structures freighter rooms (CUBEROOM_SPACE/B/C).
# cuberoom_a/b/c were shadowbox proxy cubes (24v/12f). Rebuilt 1:1 by recursively
# flattening the composite scene (floor+walls+corners+hatches with transforms).
# Same import options as the corridors.
...
NAMES = ["cuberoom_a", "cuberoom_b", "cuberoom_c"]
...
unreal.log("NMS FIX LEGACY CUBEROOMS: GOTOVO import=%d miss=%s" % (imp, miss))
try:
