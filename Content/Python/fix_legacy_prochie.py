...
# Fix Legacy Structures "ПРЕЖНИЕ ПРОЧИЕ" parts that had the WRONG mesh.
# Correct meshes resolved authoritatively via icon-name convention (Rule 18) +
# part_icons_official.json. Imported under their proper mesh names; ModelPaths
# already repointed in nms_parts_db.json.
...
NAMES = ["airlockconnector", "cuberoom", "cuberoom_innerwall",
         "wall", "room_floor", "corridor_windowframe"]
...
unreal.log("NMS FIX LEGACY PROCHIE: GOTOVO import=%d miss=%s" % (imp, miss))
try:
