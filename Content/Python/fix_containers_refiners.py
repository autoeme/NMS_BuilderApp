...
# Rebuild broken COMPOSITE Advanced Technology meshes.
# container_0-9: geometry lived only in a REFERENCE sub-scene (CUBECRATE + NUMBER_N);
#   old project mesh was a 1360-face wedge fragment. refiner2/3: geometry in REFINER2/3MODEL.
# Rebuilt via recursive scene flattener (composite_convert2, snap-guide refs excluded).
...
NAMES = ["container_0", "container_1", "container_2", "container_3", "container_4",
...
unreal.log("NMS FIX CONTAINERS/REFINERS: GOTOVO import=%d miss=%s" % (imp, miss))
try:
